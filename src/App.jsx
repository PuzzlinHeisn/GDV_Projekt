...
import MannheimMapView from './components/mapbox/MannheimMapView'
import KaiserslauternMapView from './components/mapbox/KaiserslauternMapView';
import BottomChartBar from './components/mui/appbar/BottomChartBar';
...
import TogglePieViewButton from './components/mui/buttons/TogglePieViewButton';
import TopPieBar from './components/mui/appbar/TopPieBar';
import WohnungInfoCard from './components/mui/WohnungInfoCard';

const mergedDataMap = new Map(merged_data.map(item => [item.title, item]));
...
const App = () => {
  ...
  const handleFindBestMatch = () => {
    const selectedObjectComplete = mergedDataMap.get(selectedObject);
